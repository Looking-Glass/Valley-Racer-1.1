 ...
 * versions.
 */
public class SerialThreadKA
{
    // Parameters passed from SerialControllerKA, used for connecting to the
    // serial device as explained in the SerialControllerKA documentation.
    ...
    // Indicates when this thread should stop executing. When SerialControllerKA
    ...
    // ------------------------------------------------------------------------
    public SerialThreadKA(string portName,
                        int baudRate, 
     ...
     * created by the SerialControllerKA).
     *************************************************************************/
        ...
        try
        {
            while (!IsStopRequested())
            {
                ...
                catch (Exception ioe)
                {
                    ...
                    inputQueue.Enqueue(SerialControllerKA.SERIAL_DEVICE_DISCONNECTED);
    ...
    private void AttemptConnection()
    {
        ...
        inputQueue.Enqueue(SerialControllerKA.SERIAL_DEVICE_CONNECTED);
    }
